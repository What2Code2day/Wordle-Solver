...
while final_word == False:
    ...
    if guess_color == "b" or guess_color == 'B':
        words = list(filter(lambda s: guess_letter not in s, words))
        print(words)
        continue
    ...
    if guess_color == "G" or guess_color == "g":
        words = list(
            filter(lambda s: s[letter_pos-1] == guess_letter in s, words))
        print(words)
    # filters for yellow letters
    elif guess_color == "y" or guess_color == "Y":
        words = list(filter(lambda s: guess_letter in s, words))
        words = [
            word
            for word in words
